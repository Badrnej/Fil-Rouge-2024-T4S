      ...
      <aside class="w-64 bg-white dark:bg-gray-800 shadow-md">
        ...
        <nav class="mt-4">
          <template v-if="userRole === 'admin' || userRole === 'manager'">
            ...
            <a href="http://localhost:8080/DeliveryServices.vue" class="block py-2 px-4 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700">Delivery Services</a>
          </template>
